(function () {
    ...
    // Recalculates and displays the cost breakdown (sculpture price,
    // insurance, delivery, total) whenever the shipping method or
    // country changes.
    ...
    relevantInputs.forEach(function (input) {
